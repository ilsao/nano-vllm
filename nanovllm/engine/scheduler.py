...
class Scheduler:
    ...
    def postprocess(self, seqs: list[Sequence], token_ids: list[int], is_prefill: bool):
        """
        Updates the sequences with the generated token IDs, 
        manages the block cache, and handles the completion of sequences 
        based on the end-of-sequence token or maximum tokens.
